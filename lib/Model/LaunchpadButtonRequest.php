...
class LaunchpadButtonRequest extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    public function getContent(): ContentRequestBitlink
    {
        return $this->content;
    }

    public function setContent(ContentRequestBitlink $content): self
    {
