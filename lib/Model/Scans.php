...
class Scans extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @return list<QRScans>
     */
    public function getQrScans(): array
    {
        return $this->qrScans;
    }

    /**
     * @param list<QRScans> $qrScans
     */
    public function setQrScans(array $qrScans): self
    {
        $this->initialized['qrScans'] = true;
