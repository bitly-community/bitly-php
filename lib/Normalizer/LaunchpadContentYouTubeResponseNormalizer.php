...
class LaunchpadContentYouTubeResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\LaunchpadContentYouTubeResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\LaunchpadContentYouTubeResponse::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Bitly\Model\LaunchpadContentYouTubeResponse();
        ...
        if (\array_key_exists('content', $data)) {
            $object->setContent($this->denormalizer->denormalize($data['content'], \Bitly\Model\YoutubeVideoResponse::class, 'json', $context));
            unset($data['content']);
        }
    ...
    {
        return [\Bitly\Model\LaunchpadContentYouTubeResponse::class => false];
    }
}
