...
class CityDownloadMetricsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\CityDownloadMetrics::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\CityDownloadMetrics::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Bitly\Model\CityDownloadMetrics();
        ...
        if (\array_key_exists('metrics', $data)) {
            ...
            foreach ($data['metrics'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Bitly\Model\CityDownloadMetric::class, 'json', $context);
            }
            $object->setMetrics($values);
            unset($data['metrics']);
        }
        if (\array_key_exists('other_metrics', $data)) {
            $object->setOtherMetrics($this->denormalizer->denormalize($data['other_metrics'], \Bitly\Model\OtherDownloadMetric::class, 'json', $context));
    ...
    {
        return [\Bitly\Model\CityDownloadMetrics::class => false];
    }
}
