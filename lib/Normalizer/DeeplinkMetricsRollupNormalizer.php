...
class DeeplinkMetricsRollupNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('ios') && null !== $data->getIos()) {
            $dataArray['ios'] = $this->normalizer->normalize($data->getIos(), 'json', $context);
        }
        if ($data->isInitialized('android') && null !== $data->getAndroid()) {
            $dataArray['android'] = $this->normalizer->normalize($data->getAndroid(), 'json', $context);
        }
        if ($data->isInitialized('other') && null !== $data->getOther()) {
            $dataArray['other'] = $this->normalizer->normalize($data->getOther(), 'json', $context);
        }
