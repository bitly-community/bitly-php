...
class BitlinkClicksMetricsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\BitlinkClicksMetrics::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\BitlinkClicksMetrics::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Bitly\Model\BitlinkClicksMetrics();
        ...
        if (\array_key_exists('metrics', $data)) {
            ...
            foreach ($data['metrics'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Bitly\Model\BitlinkClicksMetric::class, 'json', $context);
            }
    ...
    {
        return [\Bitly\Model\BitlinkClicksMetrics::class => false];
    }
}
