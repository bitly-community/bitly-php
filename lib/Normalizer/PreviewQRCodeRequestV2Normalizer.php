...
class PreviewQRCodeRequestV2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\PreviewQRCodeRequestV2::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\PreviewQRCodeRequestV2::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Bitly\Model\PreviewQRCodeRequestV2();
    ...
    {
        return [\Bitly\Model\PreviewQRCodeRequestV2::class => false];
    }
}
