...
class BitlinkClicksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\BitlinkClicks::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\BitlinkClicks::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('bitlinkClicks') && null !== $data->getBitlinkClicks()) {
            $values = [];
            foreach ($data->getBitlinkClicks() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $dataArray['bitlink_clicks'] = $values;
        }
    ...
    {
        return [\Bitly\Model\BitlinkClicks::class => false];
    }
}
