...
class SiteLinkPerformanceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Bitly\Model\SiteLinkPerformance::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Bitly\Model\SiteLinkPerformance::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Bitly\Model\SiteLinkPerformance();
        ...
        if (\array_key_exists('link_clicks', $data)) {
            ...
            foreach ($data['link_clicks'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Bitly\Model\SiteClicks::class, 'json', $context);
            }
        ...
        if (\array_key_exists('page', $data)) {
            $object->setPage($this->denormalizer->denormalize($data['page'], \Bitly\Model\SitesPagination::class, 'json', $context));
            unset($data['page']);
        }
    ...
    {
        return [\Bitly\Model\SiteLinkPerformance::class => false];
    }
}
