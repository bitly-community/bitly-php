...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class QRCodeCustomizationsPublicNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Bitly\Model\QRCodeCustomizationsPublic::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Bitly\Model\QRCodeCustomizationsPublic::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Bitly\Model\QRCodeCustomizationsPublic();
            ...
            if (\array_key_exists('logo', $data)) {
                $object->setLogo($this->denormalizer->denormalize($data['logo'], \Bitly\Model\QRCodeLogoPublic::class, 'json', $context));
                unset($data['logo']);
            }
            ...
            if (\array_key_exists('spec_settings', $data)) {
                $object->setSpecSettings($this->denormalizer->denormalize($data['spec_settings'], \Bitly\Model\QRCodeSpecSettingsPublic::class, 'json', $context));
        ...
        {
            return [\Bitly\Model\QRCodeCustomizationsPublic::class => false];
        }
    }
} else {
    class QRCodeCustomizationsPublicNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
