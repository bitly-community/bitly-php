...
class OrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('tierFamily') && null !== $data->getTierFamily()) {
            $dataArray['tier_family'] = $data->getTierFamily();
        }
        if ($data->isInitialized('tierDisplayName') && null !== $data->getTierDisplayName()) {
            $dataArray['tier_display_name'] = $data->getTierDisplayName();
        }
