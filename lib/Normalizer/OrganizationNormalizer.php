...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Bitly\Model\Organization::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Bitly\Model\Organization::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Bitly\Model\Organization();
            ...
            if (\array_key_exists('tier_family', $data)) {
                $object->setTierFamily($data['tier_family']);
                unset($data['tier_family']);
            }
            if (\array_key_exists('tier_display_name', $data)) {
                $object->setTierDisplayName($data['tier_display_name']);
                unset($data['tier_display_name']);
            }
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('tierFamily') && null !== $object->getTierFamily()) {
                $data['tier_family'] = $object->getTierFamily();
            }
            if ($object->isInitialized('tierDisplayName') && null !== $object->getTierDisplayName()) {
                $data['tier_display_name'] = $object->getTierDisplayName();
            }
        ...
        {
            return [\Bitly\Model\Organization::class => false];
        }
    }
} else {
    class OrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
